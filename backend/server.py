...
from app.routers import (
    ...
    notary, exploit, bounty_pro, glassbox, autopilot, scan_jobs, apikeys, usage,
)
...
for module in (auth, auth_native, scans, intel, settings, breaches, copilot, commerce, public, notary, exploit, bounty_pro, glassbox, autopilot, scan_jobs, apikeys, usage):
